...
<div class="event-card">
    ...
    <div class="event-details">
        ...
        <div class="event-location">
            <img src="<?php echo get_stylesheet_directory_uri() . '/img/location-icon.svg'; ?>"
